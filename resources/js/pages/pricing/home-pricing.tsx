    ...
    return (
        <AppearanceProvider>
            ...
            <div className="bg-background relative min-h-screen transition-colors duration-300">
                ...
                {/* Footer */}
                <footer className="bg-foreground text-primary-foreground relative z-20 py-8 transition-colors duration-300 sm:py-12 dark:bg-gray-950">
                    <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
                        <div className="flex flex-col items-center justify-between space-y-4 sm:flex-row sm:space-y-0">
                            <div className="flex items-center space-x-3">
                                <Logo showText={false} className="h-8 w-8" />
                                <Link href={route('home')}>
                                    <span className="text-lg font-bold sm:text-xl">DataColumn.ai</span>
                                </Link>
                            </div>
                        ...
                        <div className="border-border/10 dark:border-border text-primary-foreground/80 mt-6 border-t pt-6 text-center text-sm sm:mt-8 sm:pt-8">
                            <p>
                                &copy; 2025 <Link href={route('home')}>DataColumn.ai</Link>. All rights reserved.
                            </p>
                        </div>
                    </div>
                </footer>
