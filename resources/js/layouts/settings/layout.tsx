        ...
        <div className="w-full overflow-x-hidden">
            <div className="px-3 sm:px-4 lg:px-6 py-4 sm:py-6 max-w-full">
                ...
                <div className="flex flex-col lg:flex-row lg:space-y-0 lg:space-x-8 xl:space-x-12 gap-6 lg:gap-0">
                    {/* Fixed: Mobile navigation without overflow */}
                    <aside className="w-full lg:w-48 min-w-0">
                        <nav className="w-full overflow-x-auto lg:overflow-x-visible">
                    ...
                    <div className="flex-1 lg:min-w-0 min-w-0">
                        <section className="w-full space-y-6 sm:space-y-8 lg:space-y-12 max-w-full overflow-x-hidden">
                            {children}
                        </section>
                    </div>
                </div>
